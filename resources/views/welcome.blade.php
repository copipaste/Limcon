        ...
        <nav class="bg-white border-gray-200 px-4 lg:px-6 py-2.5 dark:bg-gray-800">
            <div class="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
                <a href="https://flowbite.com" class="flex items-center">
                    ...
                    <span class="self-center text-xl font-semibold whitespace-nowrap dark:text-white">LIMCOM</span>
                </a>
                <div class="flex items-center lg:order-2">
                    <a href="{{ route('helper.mision') }}"
                        class="text-gray-800 dark:text-white hover:bg-gray-50 focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-sm px-4 lg:px-5 py-2 lg:py-2.5 mr-2 dark:hover:bg-gray-700 focus:outline-none dark:focus:ring-gray-800">Mision/Vision</a>
                    <a href="{{ route('helper.problematica') }}"
                        class="text-white bg-primary-700 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 font-medium rounded-lg text-sm px-4 lg:px-5 py-2 lg:py-2.5 mr-2 dark:bg-primary-600 dark:hover:bg-primary-700 focus:outline-none dark:focus:ring-primary-800">Problematica</a>
                    <a href="{{ route('helper.solucion') }}"
                        class="text-white bg-primary-700 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 font-medium rounded-lg text-sm px-4 lg:px-5 py-2 lg:py-2.5 mr-2 dark:bg-primary-600 dark:hover:bg-primary-700 focus:outline-none dark:focus:ring-primary-800">Solucion</a>
                    <a href="{{ route('helper.index') }}"
                        class="text-white bg-primary-700 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 font-medium rounded-lg text-sm px-4 lg:px-5 py-2 lg:py-2.5 mr-2 dark:bg-primary-600 dark:hover:bg-primary-700 focus:outline-none dark:focus:ring-primary-800">MBC</a>
    ...
    <article class="mb-12 mt-16">
        ...
        <div class="grid grid-cols-1 md:gap-6 md:grid-cols-2">
            <p class="mb-3 text-gray-500 dark:text-gray-400"> Estas empresas se
                ...
                significativo en la salud pública y en la imagen de nuestra ciudad. Una ciudad limpia no solo es más
                atractiva para sus habitantes y turistas, sino que también promueve un mayor sentido de pertenencia y
                orgullo por parte de la comunidad.
            </p>
            <blockquote class="mb-3">
                <p class="text-xl italic font-semibold text-gray-900 dark:text-white">" LimCom: Donde la limpieza se
        ...
        <div class="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
            ...
            <div class="sm:flex sm:items-center sm:justify-between">
                <span class="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2023 <a
                        href="https://flowbite.com/" class="hover:underline">Limcom™</a>. All Rights Reserved.
                </span>
